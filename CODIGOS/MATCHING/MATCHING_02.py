...
# predicciones_coeficientes = modelo.get_layer('coeficientes').output
# predicciones_coeficientes = modelo.get_layer('coeficientes')(X_simulador).numpy()
# predicciones_coeficientes = modelo.get_layer('coeficientes').output
#################################
...
# Mostrar los coeficientes calibrados

print("Coeficientes calibrados:", predicciones_coeficientes)
